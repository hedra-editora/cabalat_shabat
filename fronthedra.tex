...
\ifdef{\tradutor}{{\small {\tradutor} (\textit{org.} e \textit{tradução})}\par}{}\vspace{1.5cm}

{{\footnotesize{} \ifdef{\numeroedicao}{\numeroedicao}{1}ª edição} \par}

%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{./logo.png}\hfill\logoum{}\\ São Paulo\_2018}}{\includegraphics[width=3cm]{./logo.png}\break{} São Paulo\_2019}
...
\centering\tiny\noindent{}Esta publicação é uma edição especial e primeiro\\lançamento da Ayllon Editora, com tiragem limitada\\ e numerada de 200 exemplares. \versal{ISBN: 978-85-7715-610-8}\\\vspace{5pt}Adverte-se aos curiosos que se imprimiu este livro \ifdef{\grafica}{na gráfica \grafica}{em nossas oficinas}, 
