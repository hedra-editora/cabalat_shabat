...
\linhalayout{revisão do hebraico}{Tauan Novarro}
...
{\Large \autor \par\vspace{3.2em}}
\ifdef{\organizador}{{\small {\organizador} (\textit{organização})} \par}{}
\ifdef{\introdutor}{{\small {\introdutor} (\textit{prefácio})} \par}{}
\ifdef{\tradutor}{{\small {\tradutor} (\textit{org.} e \textit{tradução})}\par}{}\vspace{4em}

{{\footnotesize{} \ifdef{\numeroedicao}{\numeroedicao}{1}ª edição} \par}

%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{./logo.png}\hfill\logoum{}\\ São Paulo\_2018}}{\includegraphics[width=3cm]{./logo.png}\break{} São Paulo\quad2020}
