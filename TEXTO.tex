...
simplesmente ``poeta''.\footnote{\emph{Shulchan Arukh}, ``Orach Chayim'' 584.} Na
...
diante do quarto''.\footnote{§62, \emph{Crestomatia Arcaica}, Fócio.}
...
nascimento pela lei judaica''.\footnote{Scholem, 167-8.} O \emph{shabat} foi assim
...
casamento sagrado, era originalmente\footnote{Conforme descrito no \emph{Schulchan Aruch}, escrito por Isaac Lúria no século \versal{XVII} (o primeiro \emph{Schulchan Aruch} foi escrito por Iossef Karo), e no \emph{Hemdat Iamim}, livro de costumes e leis judaicas baseado na cabala. [\versal{N.~E.}]} entoado nas sinagogas nas tardes de
